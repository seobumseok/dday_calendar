...
const modalMessageList = [
  { "number": 1, "message": "행복의 계절, 모두가 함께하는 클스마스이브 24일! 사랑해 예원" },
  { "number": 2, "message": "이 12월, 행복한 순간이 우리를 감싸네요. 사랑해 주원" },
  { "number": 3, "message": "다 같이 즐겁게 보내는 24일, 행복이 가득합니다! 사랑해 울자기" },
  ...
  { "number": 24, "message": "12월, 모두에게 기쁨과 행복이 넘치는 달이에요. 우리가족 건강하자!" }
];
